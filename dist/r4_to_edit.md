...
## 患者の意思決定の支援とそのための情報収集・わかりやすい説明(第2層)
...
1. 患者の多様性に配慮し分かりやすい言葉で説明できる。(例：高齢者、小児、障害者、文化・言語・慣習の違い）
1. 患者の漠然とした不安を受け止め、不安を軽減するためにわかりやすい言葉で説明でき、対話ができる。

### 患者への行動変容の促し(第3層)

1. 健康行動や行動変容を行う動機付けを活用できる。
1. 生活習慣病における患者支援（自律性支援）や保健指導を活用できる。

### 診断仮説に基づいた情報収集の実施(第3層)

1. 診断仮説を検証するために、診断仮説に基づいた情報収集を実施できる。

### インフォームド・コンセントの取得(第3層)

1. 医療を提供するに当たり、患者が理解し同意するよう適切に説明を行うことができる。
1. 治療やマネジメントに関して意思決定するために、患者側と情報共有や摺り合わせをすることができる。
1. 人生の最終段階における医療（エンド・オブ・ライフ・ケア）での患者とのコミュニケーション、頻度の高い苦痛とその対処法・ケアを活用できる。
...
### 患者や家族の課題を把握し、必要な情報を得ることができる(第3層)

1. 患者の心理的及び社会的背景や自立した生活を送るための課題を把握し、抱える問題点を抽出・整理できる。
1. 保護者から必要な情報を得たり対応したりすることに可能な範囲で参加する。
1. 情報収集には医療面接、身体診察、検査の３つの方法を活用できる。

### 患者や家族の視点から、心理・社会的背景に配慮した診療を行うことができる(第3層)

1. 家族や地域といった視点をもち、心理・社会的背景により配慮した診療に可能な範囲で参加する。
1. 家族や地域といった視点をもち、保健・医療・福祉・介護との連携を学ぶ。
1. 患者の要望（診察・転医・紹介）への対処の仕方を活用できる。
1. 患者・家族の怒りや悲しみなどの困難な感情を理解し、対応ができる。（対応することができる）
1. 不確実な状況や医学的に説明困難な症状に配慮した対応ができる。
1. 視覚・聴覚障害などのコミュニケーションが難しい患者に配慮できる
1. 電話やインターネットでの患者診療に対応ができる。（対応できる）遠隔診療におけるコミュニケーションについて概説できる。
